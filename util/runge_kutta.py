...
class RungeKuttaPars:
    ...
    """
    def __init__(self, s=2, family='LobattoIIIA'):
        """
        ...
        # --------------------------------------------------------------------
            ...
            raise ValueError('Unknown Collocation type: ', family)
    ...
    #def has_fsal(self):, def has_unnatural_coefficients(self): # check for 0 <= c_i,b_i <= 1, sum(b) = 1
