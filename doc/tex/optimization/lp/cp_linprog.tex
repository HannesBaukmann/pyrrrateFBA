...
\begin{subequations}
	...
	\\
	\nullvec_{n_{\mathrm{QSSA}}} &= \Smat_1 \cdot \uvec(t) + \Smat_3 \cdot \yvec(t) + \fvec_1
...
\begin{subequations}
	...
	\\
	\nullvec_{n_{\mathrm{QSSA}}} &= \Smat_1(t) \cdot \uvec(t) + \Smat_3(t) \cdot \yvec(t) + \fvec_1(t)
...
% %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\subsubsection*{Slope Variables}
%\todo{Is this correct? $\to$ No, it is simpler!}
\begin{align*}
...
Matrix $\Smat_3$ might actually destroy the problem structure if we want to use other algorithms than complete parameterization or eliminate the dependent flux variables.% later on. So: Is it really worth all this?
