...
\begin{center}
	{\Large\textbf{Implementation Details for \texttt{mioc\_cp\_linprog} (in \texttt{oc.py})}}
\end{center}

We have a linear \textbf{m}ixed \textbf{i}nteger \textbf{o}ptimal \textbf{c}ontrol problem of the form
\begin{subequations}
\begin{align}
...
\end{align}
\end{subequations}
\todo{Would it make more sense to use integer variables instead of Booleans?}
